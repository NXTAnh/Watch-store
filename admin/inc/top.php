...
<head>
	...
	<link href="../inc/css/custom-sidebar.css" rel="stylesheet">
	<link rel="preconnect" href="https://fonts.gstatic.com">
	<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.0/css/all.min.css">

	<title>Trang quản trị - TAShop</title>
		...
		<nav id="sidebar" class="sidebar js-sidebar">
			<div class="sidebar-content js-simplebar">
				<a class="sidebar-brand" href="">
					<span class="align-middle">TAShop</span>
				</a>
							...
							<div class="dropdown-menu dropdown-menu-lg dropdown-menu-end py-0" aria-labelledby="messagesDropdown">
								...
								<div class="list-group">
									<a href="#" class="list-group-item">
										<div class="row g-0 align-items-center">
											<div class="col-2">
												<img src="../../images/users/user.png" class="avatar img-fluid rounded-circle">
											</div>
											<div class="col-10 ps-2">
												<div class="text-dark">Khách hàng</div>
												<div class="text-muted small mt-1">Mail của khách hàng</div>
